...
model = GraphAutoEncoder(1024,3,dataset,num_layers=4, lr = lr)

wandb_logger = pl_loggers.WandbLogger(project="Equation_free", name= " 5e-4 lr, SAGE, 30 nodes, large lr no schedule,",offline=True)
